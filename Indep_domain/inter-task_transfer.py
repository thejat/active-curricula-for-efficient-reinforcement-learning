...
if __name__ == "__main__":
	...
	for Round in range(Rounds):
		...
		# print (sum(source_step))
		tot_F += (sum(source_step) + sum(sum(transfer_step)))
		print ('Total steps required to calculate F matrix: %d' % (sum(source_step) + sum(sum(transfer_step))))
		curriculum = []
